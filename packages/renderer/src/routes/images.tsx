        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200">
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-white text-gray-900 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
